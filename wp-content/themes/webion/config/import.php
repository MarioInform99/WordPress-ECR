...
$config = array(
	...
	'advanced_import' => array(
		'webion' => array(
			'label'    => esc_html__( 'Webion', 'webion' ), 
			...
			'demo_url' => 'https://ld-wp73.template-help.com/wordpress/prod_15696/v4/',
		),
	...
	'success-links' => array(
		'home' => array(
			'label'  => esc_html__( 'View your site', 'webion' ),
			'type'   => 'primary',
			'target' => '_self',
			'icon'   => 'dashicons-welcome-view-site',
			'desc'   => esc_html__( 'Take a look at your site', 'webion' ),
			'url'    => home_url( '/' ),
		),
		'customize' => array(
			'label'  => esc_html__( 'Customize your theme', 'webion' ),
			'type'   => 'primary',
			'target' => '_self',
			'icon'   => 'dashicons-admin-generic',
			'desc'   => esc_html__( 'Proceed to customizing your theme', 'webion' ),
