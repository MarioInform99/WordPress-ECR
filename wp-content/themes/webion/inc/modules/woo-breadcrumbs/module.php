...
if ( ! class_exists( 'Webion_Woo_Breadcrumbs_Module' ) ) {

	/**
	 * Define Webion_Woo_Breadcrumbs_Module class
	 */
	class Webion_Woo_Breadcrumbs_Module extends Webion_Module_Base {
		...
		public function get_wc_breadcrumbs( $is_custom_breadcrumbs, $args ) {
			...
			$wc_breadcrumbs = new Webion_WC_Breadcrumbs( $args );
