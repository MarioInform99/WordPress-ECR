...
if ( ! class_exists( 'Webion_Woo_Module' ) ) {

	/**
	 * Define Webion_Woo_Module class
	 */
	class Webion_Woo_Module extends Webion_Module_Base {
		...
		public function filters() {
			...
			add_filter( 'webion-theme/assets-depends/script', array( $this, 'assets_depends_script' ) );

			add_filter( 'webion-theme/customizer/options', array( $this, 'customizer_options' ) );

			add_filter( 'cx_customizer/core_sections', array(  $this, 'webion_customizer_core_sections' ) );
		}

		/**
		 * Add WooCommerce customizer sections
		*/
		public function webion_customizer_core_sections( $sections ) {
		...
		public function customizer_options( $options ) {
			...
			$new_options = array(
				'woocommerce_accent_color' => array(
					'title' 			=> esc_html__( 'WooCommerce Accent color', 'webion' ),
				...
				'woocommerce_settings' => array(
					'title' 			=> esc_html__( 'WooCommerce Options', 'webion' ),
					'priority' 			=> 200,
					'type' 				=> 'panel',
				),
				
				'woo_general' => array(
					'title' 			=> esc_html__( 'General', 'webion' ),
					'panel' 			=> 'woocommerce_settings',
					'priority' 			=> 1,
					'type' 				=> 'section',
				),
				'woo_header_cart_icon' => array(
					'title' 			=> esc_html__( 'Header Cart Icon', 'webion' ),
					'section' 			=> 'woo_general',
					'default' 			=> true,
					'field' 			=> 'checkbox',
					'type' 				=> 'control',
				...
				'single_product_layout' => array(
					'title' 			=> esc_html__( 'Single product layout', 'webion' ),
					'panel' 			=> 'woocommerce_settings',
					'priority' 			=> 1,
					'type' 				=> 'section',
				),
				'single_product_container_type' => array(
					'title' 			=> esc_html__( 'Single product container type', 'webion' ),
				...
				'single_product_sharing' => array(
					'title' 			=> esc_html__( 'Product Sharing', 'webion' ),
					'section' 			=> 'single_product_layout',
					'default' 			=> true,
					'field' 			=> 'checkbox',
					'type' 				=> 'control',
		...
		public function assets_depends_script( $scripts_depends ) {
			array_push( $scripts_depends, 'webion-woo-module-script' );
