...
if ( ! class_exists( 'Webion_Widget_Area' ) ) {

	class Webion_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'webion-theme/widget-area/render', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'webion-theme/widget_area/rendering_current', $area_id );
			...
			$classes = apply_filters( 'webion-theme/widget_area/classes', $classes, $area_id );
	...
	function webion_widget_area() {
		return Webion_Widget_Area::get_instance();
	}
